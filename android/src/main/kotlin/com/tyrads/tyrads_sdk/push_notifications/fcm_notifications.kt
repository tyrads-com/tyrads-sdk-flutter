...
import com.tyrads.tyrads_sdk.R
import com.tyrads.tyrads_sdk.TyradsSdkPlugin
...
class FCMNotifications private constructor() {
    ...
    internal fun handleNotificationEvent(eventType: String, data: Map<String, String>) {
        ...
        TyradsSdkPlugin.sendOrBufferEvent(eventData)
    ...
    internal fun onNotificationDismissed(dataString: String) {
        val data = try {
            ...
            mapOf("data" to dataString)
        }
        handleNotificationEvent("onDismiss", data)
    }
