...
class _AcmoOfferSliderBodyState extends State<AcmoOfferSliderBody> {
      ...
      children: [
        PageView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return InkWell(
              onTap: widget.fromDashboard == true
              ...
              child: Stack(
                children: [
                  ...
                  if (widget.showOnlyFooter == true &&
                      widget.fromDashboard == true)
                    _acmoOfferFooterTitle(offer,
                        onTap: widget.openPlayStore
                            ? () async {
                                Loading.open();
                                await widget.controller.openOffer(
                                  clickUrl: offer.tracking.clickUrl,
                                  s2sClickUrl: offer.tracking.s2sClickUrl,
                                  isRetryDownload: offer.isRetryDownload,
                                  isInstalled: offer.isInstalled,
                                  previewUrl: offer.app.previewUrl,
                                  campaignId: offer.campaignId,
                                );
                                Loading.dismiss();
                              }
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: List.generate(
                          widget.controller.hotOffers.length, (index) {
                        return TweenAnimationBuilder(
                          duration: const Duration(milliseconds: 300),
                          tween: Tween<double>(
                              begin: 0, end: value == index ? 1.2 : 1.0),
  ...
  Positioned _acmoOfferFooterTitle(AcmoOffersModel offer,
      {double? footerHeight, void Function()? onTap}) {
    return Positioned(
        bottom: 24,
        left: 0,
        right: 0,
          ...
          child: Container(
            ...
            child: Padding(
              padding: EdgeInsets.symmetric(
                  vertical: (8 * widget.shrinkOffset).clamp(0.0, 8.0)),
              child: SizedBox(
  ...
  List<Widget> _acmoOfferBackgroundImage(String imageUrl, int loopedIndex,
      [bool roundedBorderImage = false]) {
    return [
      ClipRRect(
        borderRadius:
            roundedBorderImage ? BorderRadius.circular(10) : BorderRadius.zero,
        child: ImageNetwork(
          image: imageUrl,
