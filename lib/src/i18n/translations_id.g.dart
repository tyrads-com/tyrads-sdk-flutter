...
class _TranslationsOfferDetailsId extends TranslationsOfferDetailsEn {
	...
	@override late final _TranslationsOfferDetailsAvailableOnId availableOn = _TranslationsOfferDetailsAvailableOnId._(_root);
}
...
class _TranslationsOfferDetailsAvailableOnId extends TranslationsOfferDetailsAvailableOnEn {
	_TranslationsOfferDetailsAvailableOnId._(TranslationsId root) : this._root = root, super.internal(root);

	final TranslationsId _root; // ignore: unused_field

	// Translations
	@override String get popUpButtonSuccessCopyURL => 'Disalin';
	@override String get availableOn => 'Tersedia di';
	@override String get method1 => 'Metode 1';
	@override String get method2 => 'Metode 2';
	@override String get method1ScanQR => 'Pindai kode QR dengan perangkat seluler.';
	@override String get method2CopyURL => 'Tempelkan URL ke perangkat seluler Anda.';
	@override String get buttonCopy => 'Salin';
}
