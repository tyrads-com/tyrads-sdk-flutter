...
class TranslationsOfferDetailsEn {
	...
	late final TranslationsOfferDetailsAvailableOnEn availableOn = TranslationsOfferDetailsAvailableOnEn.internal(_root);
}
...
class TranslationsOfferDetailsAvailableOnEn {
	TranslationsOfferDetailsAvailableOnEn.internal(this._root);

	final Translations _root; // ignore: unused_field

	// Translations
	String get popUpButtonSuccessCopyURL => 'Copied!';
	String get availableOn => 'Available on';
	String get method1 => 'Method 1';
	String get method2 => 'Method 2';
	String get method1ScanQR => 'Scan QR code with mobile device.';
	String get method2CopyURL => 'Paste URL into your mobile device.';
