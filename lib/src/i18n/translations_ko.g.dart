...
class _TranslationsOfferDetailsKo extends TranslationsOfferDetailsEn {
	...
	@override late final _TranslationsOfferDetailsAvailableOnKo availableOn = _TranslationsOfferDetailsAvailableOnKo._(_root);
}
...
class _TranslationsOfferDetailsAvailableOnKo extends TranslationsOfferDetailsAvailableOnEn {
	_TranslationsOfferDetailsAvailableOnKo._(TranslationsKo root) : this._root = root, super.internal(root);

	final TranslationsKo _root; // ignore: unused_field

	// Translations
	@override String get popUpButtonSuccessCopyURL => '복사됨';
	@override String get availableOn => '에서 사용 가능';
	@override String get method1 => '방법 1';
	@override String get method2 => '방법 2';
	@override String get method1ScanQR => '모바일 장치로 QR 코드를 스캔하세요.';
	@override String get method2CopyURL => '모바일 장치에 URL을 붙여넣으세요.';
